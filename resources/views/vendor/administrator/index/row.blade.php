    ...
    <td class="actions">
        <ul class="list-unstyled">
            @if ($actions->authorize('view', $item))
                <li>
                    <a href="{{ route('scaffold.view', app('scaffold.magnet')->with(['module' => $module, 'id' => $item])->toArray()) }}">
                        <i class="fa fa-eye"></i>
            ...
            @if ($actions->authorize('update', $item))
                <li>
                    <a href="{{ route('scaffold.edit', app('scaffold.magnet')->with(['module' => $module, 'id' => $item])->toArray()) }}">
            ...
            @if ($actions->authorize('delete', $item))
                <li>
                    <a onclick="return confirm('Delete. Are you sure?')"
                       href="{{ route('scaffold.delete', app('scaffold.magnet')->with(['module' => $module, 'id' => $item])->toArray()) }}">
